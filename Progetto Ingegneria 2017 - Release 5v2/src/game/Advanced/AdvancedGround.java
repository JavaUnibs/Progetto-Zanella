...
/**
 * Classe concreta che estende l'abstract product Ground. Rappresenta i luoghi che costituiscono
 * il mondo di livello avanzato.
 */
public class AdvancedGround extends Ground {
	...
	/**
	 * Costruttore della classe AdvancedGround, inizializza le variabili con i valori forniti
	 * @param height
	 * @param width
	 * @param level
	 * @param name
