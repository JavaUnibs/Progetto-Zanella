...
public class SetupWorld {
	...
	HashMap<Ground, ArrayList<Passage>> keepTrack(){                              //Tiene traccia in un hashmap dei luoghi e dei passaggi con chiavi coincidenti per mantenere la raggiungibilit� del goal
